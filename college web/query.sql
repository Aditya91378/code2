...
CREATE TABLE ACCOUNT1 (AC_NO  NUMBER (7),NAME VARCHAR2(50),BALANCE INT);
CREATE TABLE TRANSACTION1(T_ID INT ,AC_NO NUMBER (7,2),T_DATE DATE,AMOUNT NUMBER (7,2),BALANCE INT);
CREATE SEQUENCE AC_SEQ;

CREATE OR REPLACE TRIGGER TRI_AE BEFORE UPDATE ON ACCOUNT1 FOR EACH ROW 
BEGIN 
INSERT INTO TRANSACTION1(T_ID,AC_NO,T_DATE,AMOUNT,BALANCE)
VALUES (AC_SEQ.NEXTVAL,:NEW.AC_NO,SYSDATE,ABS (:NEW.BALANCE-:OLD.BALANCE),:NEW.BALANCE);
END;
--DROP TRIGGER TRI_AE;
--DROP TABLE ACCOUNT1;
--DROP TABLE TRANSACTION1;
INSERT INTO account1 VALUES (10,'AMOL',10000);
INSERT INTO account1 VALUES (20,'BHARAT',10000);
INSERT INTO account1 VALUES (30,'CASAB',10000);
INSERT INTO account1 VALUES (40,'DOLLY',10000);
INSERT INTO account1 VALUES (50,'EMMA',10000);
INSERT INTO account1 VALUES (60,'HINA',10000);
SELECT * FROM ACCOUNT1;
UPDATE  ACCOUNT1 SET BALANCE=BALANCE +5000 WHERE AC_NO=40;
UPDATE  ACCOUNT1 SET BALANCE=BALANCE -5000 WHERE AC_NO=30;
